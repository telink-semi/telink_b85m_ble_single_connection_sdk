...
static const attribute_t my_Attributes[] = {
	...
	{0,ATT_PERMISSIONS_READ,2,sizeof(my_hidReportOTAinCharVal),(u8*)(&my_characterUUID), (u8*)(my_hidReportOTAinCharVal), 0, 0},				//prop
	{0,ATT_PERMISSIONS_READ,2, sizeof(reportOTAIn),(u8*)(&hidReportUUID), 	(u8*)(reportOTAIn), 0, 0},	//value
	{0,ATT_PERMISSIONS_RDWR,2,sizeof(reportOTAInCCC),(u8*)(&clientCharacterCfgUUID), 	(u8*)(reportOTAInCCC), 0, 0},	//value
	{0,ATT_PERMISSIONS_RDWR,2,sizeof(reportRefOTAIn),(u8*)(&reportRefUUID), 	(u8*)(reportRefOTAIn), 0, 0},	//value
	// 0027 - 0029 . OTA report out: 3 (char-val-ref)
	{0,ATT_PERMISSIONS_READ,2,sizeof(my_hidReportOTAoutCharVal),(u8*)(&my_characterUUID), (u8*)(my_hidReportOTAoutCharVal), 0, 0},				//prop
	{0,ATT_PERMISSIONS_RDWR,2,sizeof(reportOTAOut),(u8*)(&hidReportUUID), 	(u8*)(reportOTAOut), &otaWrite, 0},	//value
	{0,ATT_PERMISSIONS_RDWR,2,sizeof(reportRefOTAOut),(u8*)(&reportRefUUID), 	(u8*)(reportRefOTAOut), 0, 0},	//value
#endif
